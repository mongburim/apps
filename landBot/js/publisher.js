...
templeteHTML += '            </p>';
templeteHTML += '        </div>';
templeteHTML += '        <div class="progress" style="margin-bottom:15px;">';
templeteHTML += '            <div class="progress-bar" role="progressbar" style="width: 55%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>';
templeteHTML += '        </div>';
